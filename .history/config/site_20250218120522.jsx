const description_1 : [
  "Developed responsive websites using HTML, CSS, and JavaScript, improving
      cross-browser compatibility and user accessibility.", " Collaborated with senior developers to implement SEO strategies, driving a
      15% increase in organic traffic.", "Created comprehensive documentation for web projects, streamlining team
      workflows and enhancing project clarity.", "Actively participated in daily stand-ups and sprint planning, improving
