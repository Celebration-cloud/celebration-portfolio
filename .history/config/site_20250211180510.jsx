export const siteConfig = {
  ...
  skillLogo: [
    { label: "React.js", src: "/images/react-logo.png" },
    { label: "Next.js", src: "/images/nextjs-logo.png" },
    { label: "Tailwind CSS", src: "/images/tailwindcss-logo.png"
      },
    // { label: "Framer Motion", src: "/images/framer-motion-logo.png" },
    { label: "HTML5", src: "/images/html5-logo.png" },
    { label: "CSS3", src: "/images/css3-logo.png" },
    { label: "JavaScript", src: "/images/javascript-logo.png" },
    { label: "Git", src: "/images/git-logo.png" },
    { label: "GitHub", src: "/images/github-logo.png" },
    { label: "GitHub", src: "/images/redux-logo.png" },
  ]
};
