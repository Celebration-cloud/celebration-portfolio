    ...
    <div className="relative h-screen w-full" id="scrollspyHeading1">
      ...
      <div className="absolute inset-0 flex flex-col md:flex-row items-center justify-center md:justify-around space-y-10 md:space-y-0 max-md:justify-center">
        <div className="space-y-10 text-center md:text-left" data-aos="fade-up">
          ...
          <h4 className="text-white text-5xl max-md:text-4xl max-sm:text-3xl font-bold">
            Ojingulu Celebration
          </h4>
          <h5 className="text-white text-3xl  max-md:text-2xl max-sm:text-xl  font-bold">
            <TypingAnime
        ...
        <div
          className="w-full md:w-3/4 lg:w-1/2 h-full hidden max-md:<iframe src="" frameborder="0" allowfullscreen></iframe>"
          data-aos="fade-left"
        >
          <Image
            priority
