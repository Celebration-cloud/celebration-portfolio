...
const Contact = () => {
  return (
    <div className="bg-red-500 flex items-center w-full h-full py-20 space-y-10 px-5 gap-5">
      ...
      >
        ...
        />
        <div>
          <Button className="bg-foreground-700 text-foreground-600">Send Message</Button>
        </div>
      </form>
    </div>
  );
