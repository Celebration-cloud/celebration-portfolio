  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-5">
        <Chip
          className="border-foreground-700 hover:bg-inherit cursor-pointer hover:text-white transition-all duration-300"
          radius="none"
          size=""
          variant="bordered"
        >
        ...
        <Chip
          className="border-foreground-700 hover:bg-foreground-700 hover:text-white transition-all duration-300"
          radius="none"
          size="lg"
          variant="bordered"
        >
