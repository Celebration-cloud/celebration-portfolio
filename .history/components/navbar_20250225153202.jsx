...
export const Navbar = () => {
  ...
  return (
    <HeroUINavbar shouldHideOnScroll maxWidth="2xl" position="sticky">
      ...
      <NavbarContent
        className="hidden sm:flex basis-3/5 sm:basis-full navbar bg-body-tertiary id="navbar-example2""
        justify="center"
      >
        <ul className="hidden lg:flex gap-10 justify-start ml-2 nav nav-pills">
