  ...
  return (
    <HeroUINavbar maxWidth="2xl" position="sticky">
      <NavbarContent className="basis-1/5 sm:basis-auto" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit max-[410px]:-ml-5">
          <NextLink
      ...
      {/* <NavbarContent
        className="md:flex max-sm:hidden lg:hidden basis-1/5"
        justify="end"
      >
        <NavbarMenuToggle />
      </NavbarContent> */}
      ...
      <NavbarContent className="basis-1 pl-4" justify="end">
        ...
        <NavbarItem className="sm:hidden flex items-center gap-3">
          <Link
            isExternal
