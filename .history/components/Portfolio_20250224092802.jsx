  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-5">
        <Chip
          className={`border-foreground-700 cursor-pointer hover:bg-foreground-700 hover:text-ftext-foreground-700  transition-all duration-300 ${selectedFilter === "all" ? "bg-foreground-700text-foreground-700 " : "hover:border-2"}`}
          radius="none"
          size="lg"
        ...
        <Chip
          className={`border-foreground-700 cursor-pointer hover:bg-foreground-700 hover:text-ftext-foreground-700  transition-all duration-300 ${selectedFilter === "react" ? "bg-foreground-700text-foreground-700 " : "hover:border-2"}`}
          radius="none"
          size="lg"
        ...
        <Chip
          className={`border-foreground-700 cursor-pointer hover:bg-foreground-700 hover:text-ftext-foreground-700  transition-all duration-300 ${selectedFilter === "next" ? "bg-foreground-700text-foreground-700 " : "hover:border-2"}`}
          radius="none"
          size="lg"
