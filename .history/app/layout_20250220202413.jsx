      ...
      >
        <Providers themeProps={{ attribute: "class", defaultTheme: "dark" }}>
          <div className="relative flex flex-col h-screen">
            ...
            <footer className="w-full flex items-center flex-col bg-red-500 text-white justify-center py-3 h-screen">
              <h2 className="text-2xl font-bold">Ojingulu Celebration</h2>
              <p className="text-xl font-medium">4, Prince Kosoko King&#39;s Street, Meiran, Lagos, Nigeria.</p>
              <div className="flex items-center justify-center">
                ...
                <p>
                  <Link
                    ...
                    href="mailto:ojingulu@example.com"
                  >
