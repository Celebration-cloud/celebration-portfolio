          ...
          <div className="relative flex flex-col h-screen">
            ...
            <footer className="w-full flex flex-col items-center justify-center gap-4 bg-red-500 text-white py-10 px-5">
              ...
              <div className="flex items-center justify-center gap-4">
                <Link className="text-white" to="mailto:ojinguluc@gmail.com">
                  <i
                    className="pi pi-envelope hover:text-foreground-700"
                    style={{ fontSize: "2rem" }}
                  />
                </Link>
                <Link className="text-white" to="mailto:ojinguluc@gmail.com"></Link>
                <i
