  ...
  return (
    <AosEffect>
      ...
      >
        ...
        <div className="marquee text-foreground-700 bg-foreground-400">
          <div className="marquee-inner flex justify-center items-center">
            <div className="marquee-content flex justify-center items-center">
              {siteConfig.skillLogo.map((skillLogo, idx) => (
                <span key={idx} className="inline-block mx-4">
                  <Image
                    alt={skillLogo.label}
                    className="w-50 h-50"
                    height={100}
            ...
            {/* <div className="marquee-content">
              <span key={6} className="inline-block mx-4">
                html
              </span>
              <span key={7} className="inline-block mx-4">
                css
              </span>
              <span key={8} className="inline-block mx-4">
                javascript
              </span>
              <span key={9} className="inline-block mx-4">
                react
              </span>
              <span key={10} className="inline-block mx-4">
                next.js
              </span>
            </div> */}
          </div>
