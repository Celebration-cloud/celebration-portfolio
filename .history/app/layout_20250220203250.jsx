      ...
      >
        <Providers themeProps={{ attribute: "class", defaultTheme: "dark" }}>
          <div className="relative flex flex-col h-screen">
            ...
            <footer className="w-full flex items-center flex-col gap-2 text-white justify-center py-20">
              ...
              <div className="flex items-center text-2xl font-medium justify-center">
                ...
                <Divider className="text-foreground-600 bg-foreground-400" layout="vertical" />
                <p>
                  <Link
