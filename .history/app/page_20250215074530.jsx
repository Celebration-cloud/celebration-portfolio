  ...
  return (
    <AosEffect>
      ...
      >
        ...
        <div className="marquee text-foreground-700 bg-foreground-400 my-5">
          <div className="marquee-inner">
            <div className="marquee-content">
              {siteConfig.skillLogo.map((skillLogo, idx) => (
                <div key={idx} className="inline-block mx-10 py-4">
                  <Image
                    alt={skillLogo.label}
            ...
            <div className="marquee-content">
              {siteConfig.skillLogo.map((skillLogo, idx) => (
                <div key={idx + siteConfig.skillLogo.length} className="inline-block mx-10 py-4">
                  <Image
                    alt={skillLogo.label}
                    className="w-full h-40 object-cover"
                    height={100}
