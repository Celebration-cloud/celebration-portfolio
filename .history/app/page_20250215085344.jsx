  ...
  return (
    <AosEffect>
      ...
      >
        ...
        <div className="marquee text-foreground-700 bg-foreground-400 my-5 m-0 w-[150%] max-md:w-auto">
          <div className="marquee-inner">
            <div className="marquee-content w-full max-md:flex max-md:flex-wrap max-md:justify-center max-md:overflow-hidden">
              {siteConfig.skillLogo.map((skillLogo, idx) => (
                <div
                  key={idx}
                  className="inline-block mx-10 w-full py-4 max-md:mx-2 max-md:py-2"
                >
                  <Image
                    alt={skillLogo.label}
                    className="w-au h-40 object-cover"
                    height={100}
                    src={skillLogo.src}
                    width={100}
                  />
