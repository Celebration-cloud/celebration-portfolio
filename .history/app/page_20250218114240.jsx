...
export default function Home() {
  const description_1 = (
    <ul>
      ...
      <li>
        Collaborated with senior developers to implement SEO strategies, driving
        a 15% increase in organic traffic.
      </li>
      <li>
  ...
  const description_2 = (
    <ul>
      <li>
        Built and optimized web applications using React.js and Next.js,
        enhancing load speeds and user satisfaction.
      </li>
      <li>
        Collaborated with senior developers to implement SEO strategies, driving
        a 15% increase in organic traffic.
  ...
  const experience = [
    ...
    const customizedContent = (item) => {
      return (
        <Card ti title={item.company} subTitle={item.date}>
          <p>
