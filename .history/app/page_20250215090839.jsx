    ...
    <AosEffect>
      ...
      >
        ...
        <div className="marquee text-foreground-700 bg-foreground-400 my-5 m-0 max-md:w-auto">
          <div className="marquee-inner w-fit max-md:w-full">
            <div className="marquee-content max-[1200*px]:flex max-[1200*px]:flex-wrap max-[1200*px]:justify-center overflow-hidden">
