  ...
  return (
    <AosEffect>
      ...
      >
        ...
        <div className="text-foreground-700 bg-foreground-400 my-5 m-0 max-md:w-auto">
          <div className="flex justify-around overflow-hidden items-center max-md:flex-col gap ">
            {siteConfig.skillLogo.map((skillLogo, idx) => (
              <div key={idx} className="w-full h-full max-md:w-1/4">
                <Image
                  alt={skillLogo.label}
                  className="w-full h-20 max-md:h-20 object-cover"
                  height={100}
                  src={skillLogo.src}
                  width={100}
                />
