    ...
    <AosEffect>
      ...
      >
        ...
        <div className="marquee text-foreground-700">
          <span className="inline-block text-foreground-700 animate-marquee">
            html
          </span>
          <span className="inline-block text-foreground-700 animate-marquee">
            css
          </span>
          <span className="inline-block text-foreground-700 animate-marquee">javascript</span>
          <span className="inline-block text-foreground-700 animate-marquee">react</span>
          <span className="inline-block text-foreground-700 animate-marquee">next.js</span>
        </div>
      </section>
    </AosEffect>
  );
