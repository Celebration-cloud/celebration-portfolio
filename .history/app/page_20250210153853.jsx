...
export default function Home() {
  return (
    ...
    >
      ...
      <div
        className="flex justify-around items-center h-full gap-5 max-md:flex-wrap"
        id="scrollspyHeading2"
      >
        <div className="w-1/2h-full">
          <Image
            alt="background"
            className="h-full w-full object-left-top"
            height={1080} // Set to the actual height of the image or desired height
        ...
        <div className="w-1/2 h-full text-md text-foreground-700">
          ...
          <div className="">
            <h6> Frontend Frameworks: React.js, Next.js </h6>
