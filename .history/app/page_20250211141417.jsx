    ...
    <AosEffect>
      ...
      >
        ...
        <div className="marquee text-foreground-700">
          <span key={1} className="inline-block animate-marquee">
            html
          </span>
          <span key={2} className="inline-block animate-marquee">
            css
          </span>
          <span key={3} className="inline-block animate-marquee">
            javascript
          </span>
          <span key={4} className="inline-block animate-marquee">
            react
          </span>
          <span key={5} className="inline-block animate-marquee">
            next.js
          </span>
        </div>
      </section>
